  ...
  return (
    <div className="min-h-screen relative bg-black bg-auto text-white overflow-hidden">
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute inset-0 bg-[url('/assets/background.jpg')] bg-auto md:bg-position-[center_top_-8rem] opacity-60" />
      ...
      <div ref={textRef} className="absolute inset-0 flex flex-col items-center justify-center z-10 text-center">
       <h1 className="text-[clamp(3rem,6vw,7rem)] font-bold tracking-tight inter-tight leading-tight">
