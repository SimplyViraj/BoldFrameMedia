    ...
    <section className="py-16 md:py-32">
      <div className="mx-auto max-w-6xl space-y-8 px-6 md:space-y-16">
        <div className="relative z-10 mx-auto max-w-xl space-y-6 text-center md:space-y-8">
          <h2 className="text-4xl font-medium lg:text-5xl text-[#f93535] tracking-tighter">
            Build by makers, loved by thousand developers
          </h2>
          <p className='text-[#f93535]'>
        ...
        <div className="
          flex gap-4 overflow-x-auto scroll-smooth snap-x snap-mandatory sm:grid sm:grid-cols-2 md:grid-cols-4 lg:grid-rows-2 
          [--color-card:var(--color-muted)] *:border-none *:shadow-none dark:[--color-muted:var(--color-zinc-900)]
        ">
          {/* Card 1 */}
          <Card className="grid grid-rows-[auto_1fr] gap-8 sm:col-span-2 sm:p-6 lg:row-span-2 snap-start min-w-[80%] sm:min-w-0">
            <CardHeader>
              <img
          ...
          {/* Card 2 */}
          <Card className="md:col-span-2 snap-start min-w-[80%] sm:min-w-0">
          ...
          {/* Card 3 */}
          <Card className="snap-start min-w-[80%] sm:min-w-0">
            <CardContent className="h-full pt-6">
              <blockquote className="grid h-full grid-rows-[1fr_auto] gap-6">
                <p className='text-sm lg:text-xl font-medium'>
